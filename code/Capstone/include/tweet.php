        ...
        for($i=$num_row;$i>0;$i--){
                //fetch assotiative array from result
                 ...
                 extract($row2);
                     ...
                     echo"<div id='box'><b><img id='thumbnail' src='upload/photo/$pic'> Name : $name <a id='right'><br><br>Dept : $dept </a><br><a id='link' href='faculty_tweet2.php?id=$id&name=$name&dept=$dept'>Go To Profile</a></b></div>";
                    }
